...
>(({ className, children, onPointerDownOutside, onInteractOutside, onFocusOutside, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      onFocusOutside={(e) => {
        // Keep dialog open when focus moves into a portaled Select / popover
        e.preventDefault()
        onFocusOutside?.(e)
      }}
      {...props}
